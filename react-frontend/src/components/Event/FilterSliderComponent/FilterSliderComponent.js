...
export const filterData = [{ name: "LeaderShip", activeFlag: false },
                ...
                <div className={styles.tagContainerWrappper}>
                    <div className={styles.tagContainer} style={style}>
                        ...
                        {this.state.filterData.map((m, i) => {
                            return (
                                <div onClick={() => this.activeClickHandler(i)} className={m.activeFlag ? styles.tagButtonActive : styles.tagButton}>{m.name}</div>
                            )
                        })}
                    ...
                    <div className={styles.filterOptionWrapper}>
                        <div className={styles.clearAllButton} onClick={this.onClearAllHandler}>CLEAR ALL</div>
                        <div className={styles.filterOptionBase}>
                            {
                                this.state.newArr.map((m) => {
                                    return (
                                        <div className={styles.filterOption}>{m.name}
                                            <div onClick={() => this.crossClickHandler(m.id)} className={styles.filterOptionCross} />
                                        </div>
